...
**Mid-lock doc:** [V4.0_COGNITIVE_MEMORY_MID_LOCK.md](./V4.0_COGNITIVE_MEMORY_MID_LOCK.md) · **Next:** #216 (T14 depth modes)
...
- **V4.0 Cognitive Memory (partial · mid-lock #215)** — sparks schema through context orchestration: `sparks.py`, ingest, retrieval, graph, patterns, `GET /api/cognitive/context` — **not V4.0 complete**; see [V4.0_COGNITIVE_MEMORY_MID_LOCK.md](./V4.0_COGNITIVE_MEMORY_MID_LOCK.md)
