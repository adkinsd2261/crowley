...
**As of:** V3.9.19 · V4 planned (2026-07-06)
...
**Current:** V3.9.19 Memory Quality shipped (#152–#166). **Next:** V4.0 Spark Lanes (not minted until D directs).
...
| V4.0 Spark Lanes                               | Planned after V3.9.19                       |
